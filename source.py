...
player_animation = {
    "stand" : engine.Animation([
        pygame.transform.scale(pygame.image.load("assets/Monkey_stand-1.png"), (WIDTH, HEIGHT)),
        pygame.transform.scale(pygame.image.load("assets/Monkey_stand-2.png"), (WIDTH, HEIGHT)),
        pygame.transform.scale(pygame.image.load("assets/Monkey_stand-3.png"), (WIDTH, HEIGHT)),
        pygame.transform.scale(pygame.image.load("assets/Monkey_stand-4.png"), (WIDTH, HEIGHT))
    ]),
    "walking" : engine.Animation([
        pygame.transform.scale(pygame.image.load("assets/Monkey_walk-1.png"), (WIDTH, HEIGHT)),
        pygame.transform.scale(pygame.image.load("assets/Monkey_walk-2.png"), (WIDTH, HEIGHT)),
        pygame.transform.scale(pygame.image.load("assets/Monkey_walk-3.png"), (WIDTH, HEIGHT)),
        pygame.transform.scale(pygame.image.load("assets/Monkey_walk-4.png"), (WIDTH, HEIGHT)),
        pygame.transform.scale(pygame.image.load("assets/Monkey_walk-5.png"), (WIDTH, HEIGHT)),
        pygame.transform.scale(pygame.image.load("assets/Monkey_walk-6.png"), (WIDTH, HEIGHT)) 
    ])
}
# coin
coin_animation = engine.Animation([
    pygame.transform.scale(pygame.image.load("assets/goldCoin1.png"), (28, 32)),
    pygame.transform.scale(pygame.image.load("assets/goldCoin2.png"), (28, 32)),
    pygame.transform.scale(pygame.image.load("assets/goldCoin3.png"), (28, 32)),
    pygame.transform.scale(pygame.image.load("assets/goldCoin4.png"), (28, 32)),
    pygame.transform.scale(pygame.image.load("assets/goldCoin5.png"), (28, 32)),
    pygame.transform.scale(pygame.image.load("assets/goldCoin6.png"), (28, 32)),
    pygame.transform.scale(pygame.image.load("assets/goldCoin7.png"), (28, 32)),
    pygame.transform.scale(pygame.image.load("assets/goldCoin8.png"), (28, 32)),
    pygame.transform.scale(pygame.image.load("assets/goldCoin9.png"), (28, 32))
])
coins =[pygame.Rect(800, 580, 28, 32),
        pygame.Rect(460, 390, 28, 32)] # creat frame contain coin (x, y , width, height)
# block
wood_images = pygame.image.load("assets/wood.png")
...
# monster
B_monster_images = pygame.image.load("assets/B.png") 
...
H_monster_animation =engine.Animation([
    pygame.transform.scale(pygame.image.load("assets/H-1.png"), (60, 60)),
    pygame.transform.scale(pygame.image.load("assets/H-2.png"), (60, 60)),
    pygame.transform.scale(pygame.image.load("assets/H-3.png"), (60, 60)),
    pygame.transform.scale(pygame.image.load("assets/H-4.png"), (60, 60))
])
...
pygame.display.set_caption("Amazing Monkey")
running = True
